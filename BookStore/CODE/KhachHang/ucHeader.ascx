...
<div class="header">
    <div class="div1300px ">
        ...
        <div class="divDangKyBanHang flex">
            <div>
                <asp:LinkButton CssClass="linkheader" OnClick="Unnamed_Click" runat="server">
...
<div class="dialog overlay " id="DivXacNhanEmail" runat="server" visible="false">
    <div class="dialog-body dialog-body_xacnhanemail ">
        <asp:ImageButton CssClass="imgClose" ID="imgClose" OnClick="imgClose_Click" ImageUrl="../../Image/close.jpeg" runat="server" />
        <div class="FormXacNhanGmail">
            ...
            <div class="div">
                hoặc
                <asp:LinkButton OnClick="btnBaoLoi_Click" ID="btnBaoLoi" CssClass="linkbaoloi" Text="Báo lỗi không gửi được tin nhắn" runat="server" />
            </div>
        </div>
    </div>
</div>
